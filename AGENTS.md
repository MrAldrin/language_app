...
## Repo structure:
- This repo is copied from a template for automatically deploying a marimo app to github pages.
- The project I workd on is only the language app
- The other apps and notebooks are just kept for reference regarding the automatic github deployment.
